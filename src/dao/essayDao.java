...
public class essayDao
{
    ...
    {
        String sql="INSERT INTO essay(essayID,text," +
                "userID,creator,status,createDate,latestDate,replyCount)" +
                "VALUES(?,?,?,?,?,?,?,?)";
        Object[] obj=new Object[]{ess.getEssayID(),ess.getText(),ess.getUserID()
                ,ess.getCreator(),ess.getStatus(),ess.getCreateDate(),ess.getLatestDate(),
                ess.getReplyCount()
        };
        try
        {
